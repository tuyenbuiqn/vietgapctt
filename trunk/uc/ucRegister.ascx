...
<div class="contentcenter">
    ...
    <div style="line-height: 25px;"><p class="maintitle">THÔNG TIN CƠ SỞ trồng TRỒNG</p></div>
        <div class="linerow">
            <p class="title">Tên cơ sở trồng trồng:</p><p><asp:TextBox CssClass="txtbox" ID="regTencoso" runat="server" ></asp:TextBox
        ...
        <div class="linerow">
            <p class="title">Tổng diện tích cơ sở trồng:</p><p><asp:TextBox CssClass="txtbox" 
        ...
        <div class="linerow">
            <p class="title">Đối tượng trồng:</p><p><asp:DropDownList ID="ddlDoituongnuoi" 
                CssClass="txtbox ddl" runat="server"></asp:DropDownList></p>
        </div>
        <div class="linerow">
        ...
        <div class="linerow">
            <p class="title">Chu kì trồng:</p><p><asp:TextBox CssClass="txtbox" 
