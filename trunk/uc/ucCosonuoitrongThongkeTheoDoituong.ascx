<%@ Control Language="C#" AutoEventWireup="true"  CodeFile="ucCosonuoitrongThongkeTheoDoituong.ascx.cs"  Inherits="cp_BaocaoThongke_ucCosonuoitrongThongkeTheoDoituong"   %>
...
<h1>
<span class="green">
    <span><asp:Label ID="lblDanhSachDichVu" runat="server" Text="Tra cứu Cơ sở Trồng trọt theo đối tượng trồng"></asp:Label></span>
</span>
</h1>
...
<table id="hor-minimalist-b">
    ...
    <td>
        ...
        <table id="hor-minimalist-b">
            <tr><th colspan="2">Thống kê các hộ trồng <asp:Label ID="lblDoituongnuoi" runat="server" Text=""></asp:Label></th></tr>
