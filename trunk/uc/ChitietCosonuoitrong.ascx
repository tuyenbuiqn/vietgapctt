        ...
        <thead>
            <tr>
                <th scope="col" colspan="4">                    
                    <asp:Label ID="lblThongTinTaiLieu" runat="server" Text="Thông tin Cơ sở Trồng trọt"></asp:Label>
                </th>
            </tr>
        </thead>
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <asp:Label ID="lblChukynuoiL" runat="server" Text="Chu kỳ trồng"></asp:Label>
                </td>
                <td>
            ...
            <tr>
                ...
                <td>
                    <asp:Label ID="lblDientichaonuoiL" runat="server" Text="Diện tích "></asp:Label>                        
                </td>
                <td>
            ...
            <tr>
                <td>
                    <asp:Label ID="lblHinhthucnuoiL" runat="server" Text="Hình thức trồng"></asp:Label>  
                </td>
                <td>
