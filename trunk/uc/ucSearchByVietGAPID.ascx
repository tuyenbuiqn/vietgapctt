...
<p>
    <input type="text" class="boxradius" id="txtVietGAPID" value="" style="width:100%; " maxlength="100"  
...
<h4 style="margin-left:0px;">Cây trồng/Sản phẩm</h4>
    <input type="text" class="boxradius" id="Text1" value="" style="width:100%; " maxlength="100"  
           tabindex="1" runat="server" />
          <%-- onfocus="if(this.value=='<%$ Resources:Language, ltrTracumasoVietGAP%>') {this.value='';}" onblur="if(this.value=='') {this.value='<%$ Resources:Language, ltrTracumasoVietGAP%>';}" --%>
            </p>  
