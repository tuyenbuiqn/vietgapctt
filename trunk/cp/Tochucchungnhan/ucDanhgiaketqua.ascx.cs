...
{
    //===============================
    // ID Cơ sở Trồng trọt, sau này sẽ thay bằng ID cơ sở của user đăng nhập
    int PK_iCosonuoitrongID = 3;
    //===============================
    bool bDatontai = false;//Kiểm tra Cơ sở Trồng trọt hiện tại đã có bảng đánh giá nội bộ chưa
