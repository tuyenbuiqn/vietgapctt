...
public partial class uc_ucDanhsachHosodangky : System.Web.UI.UserControl
{
    ...
    protected void lbnPrev_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("~/cp/Tochucchungnhan/Default.aspx?page=DanhsachCosonuoitrong");
    }
    ...
    protected void rptCosonuoitrong_ItemCommand(object source, RepeaterCommandEventArgs e)
    {
        ...
        switch(lbtnSource.CommandName)
        {
            case "Danhgianoibo":
                ...
                Response.Redirect(ResolveUrl("~/cp/Tochucchungnhan/Default.aspx?page=Danhgiaketqua"));
                break;
            case "Giaytokemtheo":
            ...
            case "Capmaso":
                ...
                Control ctrThongtinCapmaso = LoadControl("~/cp/Tochucchungnhan/ucThongtinDangky.ascx");
    ...
    protected void btnLuuGiaytonopkem_Click(object sender, EventArgs e)
    {
        ...
        {
            Response.Redirect(ResolveUrl("~/cp/Tochucchungnhan/Default.aspx?page=DanhsachCosonuoitrong"));
        }
    }
    ...
    protected void btnCapmaso_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            {
                Response.Redirect(ResolveUrl("~/cp/Tochucchungnhan/Default.aspx?page=DanhsachHosodangky"));
            }
            ...
            {
                INVI.INVILibrary.MessageBox.Show("Cơ sở Trồng trọt đã được cấp mã số");
            }
