...
<link href='<%=ResolveUrl("~/cp/Tochucchungnhan/css/tccn.css") %>' rel="stylesheet" type="text/css" />
<h1>
    <span class="green">
        Danh sách các Cơ sở Trồng trọt đăng ký
    </span>
</h1>
<div class="header">
</div>
...
<asp:Panel runat="server" ID="panCapmaso" Visible="false">
    <fieldset>
        <legend>Hồ sơ đăng ký hộ trồng </legend>
