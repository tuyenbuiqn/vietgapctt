<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ucBaocaodanhgianoibo.ascx.cs" Inherits="cp_ucBaocaodanhgianoibo" %>
<table>
    <tr>
        <td style="border:1px;">
    ...
    ngày      tháng    năm 2011 của Bộ trưởng Bộ Nông nghiệp và Phát triển nông thôn)
                ...
                <div class="content">
                    ...
                    <ul class="s13">
                        ...
                        <li>Địa chỉ cơ sở trồng: <asp:label runat="server" text="" id="lblDiachiCoso" ></asp:label></li>
                        <li>
                    ...
                    <p class="bold">
                	    Sau khi tiến hành đánh giá nội bộ, Cơ sở trồng chúng tôi xin gửi tới Quý cơ quan kết quả <br />kết quả đánh giá (Bảng 1).<br /><br />
                ...
                <div class="foot">
                    ...
                    <div class="foot_right">
                	    <span class="bold">Đại diện chủ cơ sở trồng</span><br />
                        <span class="innghieng">(Ký, ghi rõ họ tên)</span>
                    </div>
                </div>
            </div>
