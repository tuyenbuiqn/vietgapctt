<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ucChuyengia.ascx.cs" Inherits="cp_Tochucchungnhan_ucChuyengia" %>
<link href='<%=ResolveUrl("~/cp/css/report.css")%>' rel="stylesheet" type="text/css" />
<%--<link rel="Stylesheet" media="screen" type="text/css" href="<%=ResolveUrl("~/cp/css/Grid_View.css")%>" />--%>
    ...
    <table class="thechuyengia">
        	...
        	<tr>
            	<td class="center bold">
                    ...
                    <asp:Label ID="lblCoquanchidinh" runat="server" Text="Tổng cục "></asp:Label>
                </td>
                <td class="center">
