<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ucFaqCategory.ascx.cs" Inherits="cp_ucFaqCategory" %>
...
<AlternatingRowStyle CssClass="GridAltItem"></AlternatingRowStyle>
    ...
    <tr>
        <td>
       <asp:HyperLink ID="lnkAdd" runat="server" Text="Thêm mới|" NavigateUrl="~/cp/Default.aspx?page=FaqCategory&do=add" />
