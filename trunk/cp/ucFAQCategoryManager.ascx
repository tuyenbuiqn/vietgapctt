<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ucFAQCategoryManager.ascx.cs" Inherits="cp_ucDocumentCategoryManager" %>
...
<AlternatingRowStyle CssClass="GridAltItem"></AlternatingRowStyle>
    ...
    <tr>
        <td>
       <asp:HyperLink ID="lnkAdd" runat="server" Text="Thêm mới|" NavigateUrl="~/cp/Default.aspx?page=FAQCategoryUpdate&do=add" />         
