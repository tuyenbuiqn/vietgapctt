<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ucTochuccapphepQuanLy.ascx.cs"
    Inherits="cp_ucTochuccapphepQuanLy" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<link href="../css/Grid_View.css" rel="stylesheet" type="text/css" />
<link href="<%=ResolveUrl("~/cp/css/popupStyle.css")%>" rel="stylesheet" type="text/css" />
...
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
    <ContentTemplate>
        ...
        <table style="width: 100%;">
            ...
            <tr>
                <td>
                    <asp:HyperLink ID="lnkAdd" runat="server" Text="Thêm mới|" NavigateUrl="~/cp/Default.aspx?page=TochuccapphepUpdate&do=add" />
