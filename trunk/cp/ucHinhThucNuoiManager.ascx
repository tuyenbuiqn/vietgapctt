<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ucHinhThucNuoiManager.ascx.cs" Inherits="cp_ucHinhThucNuoiManager" %>
<link href="../CSS/Grid_View.css" rel="stylesheet" type="text/css" />

<h2>
Quản Lý Thông Tin Hình Thức trồng
</h2>
...
<asp:Panel ID="pnAdd" runat="server" Visible="false" >
    ...
    <div class="m">
        <fieldset>
            <legend>Thông tin hình thức trồng</legend>
            <div class="a">
                <div class="l">
