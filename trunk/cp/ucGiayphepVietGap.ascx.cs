...
public partial class cp_ucGiayphepVietGap : System.Web.UI.UserControl
{
    int iVietGAPID;
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            {
                // Phải lấy ID của Mã số VIỆT GAP theo Cơ sở Trồng trọt
    ...
    public void hienChungNhanVietGAPtheoID(Int32 id)
        ...
        protected void ExportToWord(object sender, EventArgs e)
        {
            ...
            builder.Writeln();
            builder.Font.Bold = true;
            builder.Write("Cơ sở trồng/Nhà sản xuất/sơ chế: ");
            builder.Font.Bold = false;
            ...
            builder.Font.Bold = true;
            builder.Write("Diện tích trồng/Quy mô sản xuất/Diện tích sản xuất/sơ chế:: ");
            builder.Font.Bold = false;
        ...
        private static void InsertWatermarkText(Document doc, int PK_iTochucchungnhanID)
        {
            ...
            string imgPath = System.Web.HttpContext.Current.Server.MapPath("~/") + "\\cp\\img\\giaycn.jpg";
            ...
            //imgPath = System.Web.HttpContext.Current.Server.MapPath("~/") + "\\cp\\img\\logo thuysan.png";
