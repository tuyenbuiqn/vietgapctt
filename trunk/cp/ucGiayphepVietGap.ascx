<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ucGiayphepVietGap.ascx.cs" Inherits="cp_ucGiayphepVietGap" %>
            ...
            <td colspan="2">
                <div class="chungnhan">
                    <table class="chungnhan">
                        ...
                        <tr>
                            <td colspan="2">
                                Cơ sở trồng/Nhà sản xuất/sơ chế:
                                ...
                                Diện tích trồng/Quy mô sản xuất/Diện tích sản xuất/sơ chế:
                                <span class="normal-text">
