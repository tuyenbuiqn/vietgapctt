<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ucCosonuoitrong.ascx.cs" Inherits="cp_ucCosonuoitrong" %>
...
<asp:GridView ID="grvCosonuoitrong" runat="server" AutoGenerateColumns="False" onrowdatabound="grvNews_RowDataBound" 
    ...
    <Columns>
        ...
        <asp:TemplateField HeaderText="Đối tượng trồng" 
        ...
        <asp:TemplateField>
            <ItemTemplate>
                <asp:HyperLink ID="hypXuly" runat="server" 
                    NavigateUrl='<%# Eval("PK_iCosonuoitrongID", "~/cp/default.aspx?page=Xulyvipham&cosonuoitrongID={0}") %>' 
        ...
        <asp:TemplateField>
            <ItemTemplate>
                <asp:HyperLink ID="hypCapgiayphep" runat="server" 
                    NavigateUrl='<%# Eval("PK_iCosonuoitrongID", "~/cp/default.aspx?page=GiayphepVietGap&PK_iCosonuoitrongID={0}") %>' 
...
<AlternatingRowStyle CssClass="GridAltItem"></AlternatingRowStyle>
    ...
    <tr>
       ...
       <asp:HyperLink ID="lnkAdd" runat="server" Text="Thêm mới|" 
                NavigateUrl="~/cp/Default.aspx?page=CosonuoitrongUpdate_&amp;do=add" />
...
<asp:LinkButton ID="lbtnExportAll" runat="server" CausesValidation="False" 
                ToolTip="Xuất toàn bộ dữ liệu về Cơ sở Trồng trọt" 
                onclick="lbtnExportAll_Click">Xuất toàn bộ dữ liệu</asp:LinkButton>|
<asp:HyperLink ID="hypImport" runat="server" Text="Nhập từ Excel|" NavigateUrl="~/cp/Default.aspx?page=ImportCosonuoitrong" />
</td>
    </tr>
</table>