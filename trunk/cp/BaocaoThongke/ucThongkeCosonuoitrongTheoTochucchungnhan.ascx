<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ucThongkeCosonuoitrongTheoTochucchungnhan.ascx.cs" Inherits="cp_BaocaoThongke_ucThongkeCosonuoitrongTheoTochucchungnhan" %>
<style type="text/css">
    #backgroundPopup
    {
        position: fixed;
