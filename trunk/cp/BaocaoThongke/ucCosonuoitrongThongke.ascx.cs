...
public partial class cp_BaocaoThongke_ucCosonuoitrongThongke : System.Web.UI.UserControl
{
    ...
    protected void rptCosonuoitrongThongke_ItemCreated(object sender, RepeaterItemEventArgs e)
    {
        if (e.Item.ItemType == ListItemType.Header)
        {
            ...
            ltrHeader.Text = "<h3>Thống kê thông tin về Cơ sở Trồng trọt theo - "+ddlDoituongnuoi.SelectedItem.Text+"</h3>";
        }
        else if (e.Item.ItemType == ListItemType.Footer)
        {
            ...
            barChartCosonuoi.ToolTip = "Tỉ lệ số hộ trồng theo đối tượng trồng";
            ...
            chartCosonuoiDientich.ToolTip = "Tỉ lệ diện tích theo đối tượng trồng";
            ...
            chartSanluong.ToolTip = "Tỉ lệ sản lượng theo đối tượng trồng";
    ...
    /// <summary>
    /// Lấy dữ liệu tổng hợp về Cơ sở Trồng trọt theo:
    /// </summary>
