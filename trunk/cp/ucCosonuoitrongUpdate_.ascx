<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ucCosonuoitrongUpdate_.ascx.cs"
    Inherits="cp_ucCosonuoitrongUpdate" %>
...
//    
    ...
    $(function () {
        ...
        var bDatontai = false; //Cho biết cơ sở trồng hiện tại đã tồn tại sơ đồ chưa
        var fKinhdo = null;
        var fVido = null;
        var geocoder = new google.maps.Geocoder();
        ...
        $('#btnSave').click(function () {
            ...
            {
                $('#dataPanel').empty();
                $('#dataPanel').append('Đăng ký tài khoản trước khi đăng ký Cơ sở Trồng trọt!');
                return;
            }
            kiemtraSodoCosonuoi();
            if (bDatontai == true) {
                $('#dataPanel').empty();
                $('#dataPanel').append('Một Cơ sở Trồng trọt chỉ được phép vẽ một sơ đồ!\nXóa sơ đồ hiện tại để vẽ sơ đồ mới.');
                return;
            }
            $('#dataPanel').empty();
            if (null == creator.showData()) {
                $('#dataPanel').append('Hãy vẽ sơ đồ  trước');
            } else {
...
<asp:Panel ID="pnCSNT" runat="server">
    <div class="m">
        <fieldset>
            <legend>Thông tin Cơ sở Trồng trọt</legend>
            <div class="a">
                <div class="l">
                    Tên Cơ sở Trồng trọt</div>
                <div class="r">
            ...
            <div class="a">
                <div class="l">
                    Tổng diện tích cơ sở trồng (m<sup>2</sup>)</div>
                <div class="r">
            ...
            <div class="a" style="display:none;">
                ...
                <div class="r">
                    <asp:TextBox ID="txtTongDienTichMatNuoc" Text="0" runat="server"></asp:TextBox>
                </div>
                <div class="rr">
                </div>
            </div>
            <div class="a" style="display:none;">
                <div class="l">
                    Diện tích  (m<sup>2</sup>)</div>
                <div class="r">
                    <asp:TextBox Text="0" ID="txtDienTichAoLang" runat="server"></asp:TextBox>
                </div>
                <div class="rr">
                </div>
            </div>
