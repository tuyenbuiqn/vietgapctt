<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ucAdv.ascx.cs" Inherits="cp_ucAdv" %>
...
<asp:HyperLink ID="lnkAdd" runat="server" Text="Thêm mới|" NavigateUrl="~/cp/Default.aspx?page=AdvUpdate&do=add" />
