...
--/*sp kiểm tra sự tồn tại của dánh giá kết quả theo ID Cơ sở Trồng trọt
...
--/*sp xóa toàn bộ kết quả đánh giá theo ID Cơ sở Trồng trọt
...
--/*sp tìm Danhgiaketqua theo ID Cơ sở Trồng trọt và ID chỉ tiêu
...
--/*sp Lấy tọa độ Cơ sở Trồng trọt theo huyện
...
--/*sp Lấy tọa độ Cơ sở Trồng trọt cả nước
