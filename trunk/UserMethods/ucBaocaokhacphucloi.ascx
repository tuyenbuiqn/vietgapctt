<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ucBaocaokhacphucloi.ascx.cs" Inherits="cp_ucBaocaokhacphucloi" %>
<table>
<tr>
    <td>
...
<td>
    <b>Thông tin chung:</b>
    <ol>
        <li>Tên cơ sở trồng:<asp:Label ID="lblTencosonuoi" runat="server" Text=""></asp:Label>
        </li>
        <li>Địa chỉ, vùng trồng:<asp:Label ID="lblDiachi" runat="server" Text=""></asp:Label>
        </li>
