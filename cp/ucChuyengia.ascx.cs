...
public partial class cp_Tochucchungnhan_ucChuyengia : System.Web.UI.UserControl
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            napCblGiaychungnhan();
            this.napGridView();
            lblCoquanchidinh.Text = "TỔNG CỤC ";
            lblLinhvucdanhgia.Text = "";
        }
    ...
    private void napThongtinthechuyengia(Int16 _PK_iChuyengiaID)
    {
        ...
        String sUrlViewImage = ResolveUrl("~/cp/ViewImage.aspx");
