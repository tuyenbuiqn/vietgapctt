<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ucGiaydangkyhoatdongchungnhan.ascx.cs" Inherits="cp_ucBaocaodanhgianoibo" %>
<link href='<%=ResolveUrl("~/cp/css/report.css") %>' rel="stylesheet" type="text/css" />
<%--liemqv--%>
<table>
    <tr>
        <td style="border:1px;">
            ...
            <div id="baocao_noibo">
                ...
                <div class="content">
                    ...
                    <p>
                        ...
                        số     /2011/TT-BNNPTNT ngày    tháng     năm 2011 của Bộ trưởng Bộ Nông nghiệp và Phát triển nông thôn ban hành Thông tư chứng nhận thực hành trồng thuỷ sản tốt (VietGAP) chúng tôi nhận thấy có đủ các điều kiện để hoạt động chứng nhận VietGAP cho...
