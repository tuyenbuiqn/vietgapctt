...
public partial class cp_Tochucchungnhan_Default : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            string strControl = "~/cp/Tochucchungnhan/"; // thư mục admin/Tochucchungnhan
        ...
        else if (!Page.IsPostBack) // Tự động hiển thị luôn danh sách các Cơ sở Trồng trọt đăng ký.
        {
            string strControl = "~/cp/Tochucchungnhan/"; // thư mục admin/Tochucchungnhan
