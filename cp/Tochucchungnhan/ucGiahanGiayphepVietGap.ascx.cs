...
public partial class cp_ucGiahanGiayphepVietGap : System.Web.UI.UserControl
{
    ...
    protected void grvMasoVietGap_SelectedIndexChanging(object sender, GridViewSelectEventArgs e)
    {
        ...
        if (lstMasoVietGap.Count >= 2)
        {
            ...
            if (lstMasoVietGap[0].dNgayhethan.Year == DateTime.Now.Year)
                Response.Write("<script language=\"javascript\">alert('Cơ sơ trồng này đã được gia hạn một lần trong năm.');location='Default.aspx?page=GiahanGiayphepVietGap';</script>");
        }
