...
public partial class cp_ucTochuccapphepQuanLy : System.Web.UI.UserControl
{
    ...
    protected void grvTochuccapphep_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        if (e.CommandName == "cmdReport")
        {
            ...
            Response.Redirect("~/cp/Default.aspx?page=TochuccapphepDanhgia");
        }
    ...
    protected void grvTochuccapphep_SelectedIndexChanging(object sender, GridViewSelectEventArgs e)
    {
        ...
        Response.Redirect("~/cp/Default.aspx?page=TochuccapphepUpdate&PK_iTochucchungnhanID="+iTochuccapphepID);
    }
    ...
    protected void ddlHinhthucxuly_SelectedIndexChanged(object sender, EventArgs e)
    {
        switch (ddlHinhthucxuly.SelectedIndex)
        {
            ...
            case 2:
                ...
                break;
            case 3:
                txtLydo.Text = "a. Kết quả kiểm tra giám sát cho thấy bằng chứng không đáp ứng yêu cầu theo VietGAP hoặc sản phẩm trồng không đảm bảo an toàn thực phẩm\n";
                ...
                txtLydo.Text += "d. Vi phạm quy định về kiểm tra chứng nhận, xuất xứ sản phẩm trồng.";
                break;
        }
    }
}