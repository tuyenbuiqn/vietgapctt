<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ucDocumentCategoryManager.ascx.cs" Inherits="cp_ucDocumentCategoryManager" %>
...
<AlternatingRowStyle CssClass="GridAltItem"></AlternatingRowStyle>
    ...
    <tr>
       ...
       <asp:HyperLink ID="lnkAdd" runat="server" Text="Thêm mới|" 
                NavigateUrl="~/cp/Default.aspx?page=DocumentCategoryUpdate&amp;do=add" /> 
