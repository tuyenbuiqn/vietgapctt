...
using INVI.Business;
public partial class cp_BaocaoThongke_ucThongkeCosonuoitrongTheoTochucchungnhan : System.Web.UI.UserControl
{
    ...
    protected void rptCosonuoitrongThongke_ItemDataBound(object sender, RepeaterItemEventArgs e)
    {
        ...
        if (e.Item.ItemType == ListItemType.Item)
        {
            ...
            if (rptCosonuoitrong != null)
            {
                ...
                // Lấy theo Mã số Việt Gap để lấy Cơ sở Trồng trọt
