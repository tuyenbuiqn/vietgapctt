...
public partial class cp_ucMasoVietGapQuanLy : System.Web.UI.UserControl
{
    ...
    protected void btnOk_Click(object sender, EventArgs e)
    {
        if (Page.IsValid)
        {
            try
            {
                ...
                // Check lại, vì chỉ thể sửa đổi thời hạn, chứ không thể sửa đổi được tổ chức cấp phép --> Cơ sở Trồng trọt.
