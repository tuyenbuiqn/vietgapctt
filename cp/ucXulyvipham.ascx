<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ucXulyvipham.ascx.cs" Inherits="cp_ucXulyvipham" %>
<frameset>
    <legend>Xử lý vi phạm đối với cơ sở trồng</legend>
    <table>
        <tr>
            <td>Thông tin cơ sở trồng: </td>
            <td>
                <ul>
                    <li><b>Tên cơ sở trồng: </b><asp:Label ID="lblTencosonuoi" runat="server"></asp:Label></li>
        ...
        <tr>
            ...
            <td>
                <%--<ul style="list-style-type:lower-alpha">
                    <li>Kết quả kiểm tra giám sát cho thấy bằng chứng không đáp ứng yêu cầu theo VietGAP hoặc sản phẩm trồng không đảm bảo an toàn thực phẩm;</li>
                    ...
                    <li>Vi phạm quy định về kiểm tra chứng nhận, xuất xứ sản phẩm trồng.</li>
