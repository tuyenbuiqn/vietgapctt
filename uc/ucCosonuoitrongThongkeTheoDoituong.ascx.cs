...
using INVI.Business;
using System.Data;
public partial class cp_BaocaoThongke_ucCosonuoitrongThongkeTheoDoituong : System.Web.UI.UserControl
{
    ...
    protected void btnXem_Click(object sender, EventArgs e)
    {
        ...
        if (PK_iDoituongID > 0)
        {
            ...
            //Lấy các hộ trồng theo đối tượng
            lstCoso = lstCoso.FindAll(
            delegate(CosonuoitrongEntity oCoso)
            {
            ...
            lblTranghthai.Text = "Có " + lstCoso.Count + " hộ trồng " + ddlDoituongnuoi.SelectedItem.Text + " trên tổng số " + iTongso.ToString() + " hộ.";
