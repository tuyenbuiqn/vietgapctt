...
<script type="text/javascript">
    ...
    function initMap() {
        ...
        gml.parse("Dữ liệu Cơ sở Trồng trọt");
    ...
    function getDataSuccessed(result) {
        ...
        if (data.tblCosonuoitrong.length > 0) {
            table = "";
            table += '<table id=\"hor-minimalist-b\" summary=\"Thông Tin Cơ sở Trồng trọt\" width=\"550\">';
            table += '<thead>';
            ...
            table = "";
            table += '<table id=\"hor-minimalist-b\" summary=\"Thông Tin Cơ sở Trồng trọt\" width=\"350\">';
            table += '<tr>';
  ...
  //      Tạo header table
        ...
        ExcelSheet.ActiveSheet.Cells(0, 3).Value = 'T.Diện tích ';
